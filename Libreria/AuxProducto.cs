...
namespace Libreria
{
    ...
    {
        private List<Producto> DatosProductos; /// you should fix this 
        ...
        public int DardeBaja(int idProducto)
        {
            ...
            if(p!=null)
            {
                p.Estado = false;  //no altera el valor de retorno, agregado para materias de prueba
                res = 1;
            }
        ...
        public int Modificar(int idProd, string nuevoNombre, Categoria nuevaCategoria, int nuevoPrecio, int nuevoStock)
        {
            ...
            if(prod!=null)
            {
                prod.Nombre = nuevoNombre;   //no altera el valor de retorno, agregado para materias de prueba
